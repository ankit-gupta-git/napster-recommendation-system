        ...
        <AnimatePresence>
            {isOpen && (
                <>
                    ...
                    <div className="fixed inset-0 z-[70] overflow-y-auto flex items-center justify-center p-4 md:p-8 pointer-events-none">
                        <motion.div
                            initial={{ opacity: 0, scale: 0.95, y: 20 }}
                            animate={{ opacity: 1, scale: 1, y: 0 }}
                            exit={{ opacity: 0, scale: 0.95, y: 20 }}
                            className="pointer-events-auto w-full max-w-4xl bg-[#181818] rounded-md shadow-2xl overflow-hidden flex flex-col relative max-h-[90vh] md:max-h-[85vh] overflow-y-auto"
                        >
                            {/* Close Button */}
                            <button
                                onClick={onClose}
                            ...
                            {/* Content info */}
                            <div className="p-8 md:p-12 grid md:grid-cols-[2fr_1fr] gap-8 bg-[#181818]">
